class ProjectsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @project.save
        format.html { redirect_to projects_url, suceess: 'Project was successfully created.' }
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:title, :description, :start_date, :end_date, :client_id)
    end
end
